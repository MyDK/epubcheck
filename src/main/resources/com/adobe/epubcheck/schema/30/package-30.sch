...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
	...
	<pattern id="opf.itemref.spread.portrait.deprecated">
		<rule context="opf:spine/opf:itemref[@properties]">
			<report test="(some $token in tokenize(@properties,' ') satisfies (normalize-space($token) eq 'rendition:spread-portrait'))">WARNING: Use of the 'rendition:spread-portrait' spine override is deprecated in favour of 'rendition:spread-both'</report>
		</rule>
	</pattern>
